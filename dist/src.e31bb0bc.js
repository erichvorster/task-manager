...
var radioOption = document.querySelectorAll(".form-check-input");
...
function newTodo() {
  todoBtn.addEventListener("click", function (e) {
    ...
    todoList.prepend(todoItem); //Add li to tod container
    ...
    todoItem.append(completeButton); //Add level of importance
...
newTodo(); //Implementing delete and complete buttons

todoList.addEventListener("click", function (e) {
  var selected = e.target;

  if (selected.classList[0] == "complete-button") {
    var todo = selected.parentElement;
